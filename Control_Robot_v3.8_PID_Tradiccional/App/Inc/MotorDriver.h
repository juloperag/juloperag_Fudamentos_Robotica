...
typedef struct
{
	...
	float ang_Giro;   									 //angulo de giro [rad]
...
{
	float u;
	float e, e_prev, Integral;   			//Errores anteriores de errores
	float timer_sampling;                   //Tiempo de muestreo
	float Kp, Ki, Kd; 					 	//Costantes del PID
...
typedef struct
{
	...
	float velocityBack;			            //Velocidad anterior
