...
//--------------------------PWM-------------------------------
GPIO_Handler_t handler_GPIO_PWM = {0};       //Definimos un elemento del tipo GPIO_Handler_t (Struct), BasicTimer_Config_t  y PWM_Handler_t para el uso del PWM
BasicTimer_Handler_t handler_TIMER_PWM = {0};
